...
def build_spn(numpy_data, feature_types, spn_params, rand_gen):
    ...
    for feature_type in feature_types:
        if feature_type == "discrete":
            ...
            raise Exception("Unknown feature type for SPN_experiments: " + feature_type)
    ...
    #Method to create leaves in the SPN_experiments
...
def Expectation(spn, feature_scope, evidence_scope, evidence, node_expectation, node_likelihood):
    ...
    """Compute the Expectation:
        ...
        E[X_feature_scope | X_evidence_scope] given the spn and the evidence z_data
    ...
    evidence -- numpy 2d array of the evidence z_data
    """
