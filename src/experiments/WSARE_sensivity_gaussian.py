...
if __name__ == '__main__':
    ...
    for min_parameter_value in min_parameter_values:
        ...
        for data_stream_id in data_stream_ids:
            logger.info("Evaluate minimum parameter " + str(min_parameter_value) + " on  data stream " + str(data_stream_id) + "...")
            ...
            algo = Benchmark(syndrome_counter, distribution="gaussian", min_parameter=min_parameter_value)
