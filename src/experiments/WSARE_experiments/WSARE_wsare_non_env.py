...
if __name__ == '__main__':
    ...
    df = evaluation_engine.evaluate_algorithms(
        ...
        multiple_data_stream_params=[{"data_stream_id": data_stream_id, "environmental_variables": False}
    ...
    # print results
    io.print_pretty_table(df[["algo_params", "syndrome_counter_params", "macro-averaged parital AMOC 5%"]])
