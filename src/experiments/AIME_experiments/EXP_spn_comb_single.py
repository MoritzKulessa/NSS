...
from data.data_stream import WSARE_DATA, ED_DATA_RANDOM, ED_DATA_RANDOM_ONE_STREAM3
...
if __name__ == '__main__':
    ...
    elif dataset_name == "ED_DATA_RANDOM":
        data_stream_class = ED_DATA_RANDOM
        multiple_data_stream_params = [{"data_stream_id": data_stream_id,
                                        "environmental_variables": environmental_valriables, "k": 1.0}
                                       for data_stream_id in data_stream_ids]
