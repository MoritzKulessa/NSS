    ...
    for min_support in min_supports:
        for ref_windows in ref_windows_confs:
            ...
            for data_stream_id in data_stream_ids:
                ...
                #configure algorithm
                algo = DMSS(data_stream, min_support_set=min_support, min_support_rule=min_support, ref_windows=ref_windows)
                
                #path to store computed results
                result_ident = module_name + "_min_support=" + str(min_support) + "_ref_windows=" + get_hash(str(ref_windows)) + "_" + data_stream.get_ident()
